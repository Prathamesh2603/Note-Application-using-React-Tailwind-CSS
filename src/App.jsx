    ...
    <>
      <div className="bg-blue-100 h-screen w-full">
        <div className="px-14 py-8">
            <form onSubmit={handleSubmit} className="bg-blue-50 flex flex-col items-start p-7 rounded-md shadow-md">
        ...
        <div className='px-14 h-1/2'>
          ...
          <div id='list-container' className='h-[80%] flex items-center gap-6 overflow-x-auto'>
            <div className='bg-white h-[80%] w-65 rounded-md p-3 shadow-lg shrink-0'>
              <div className='flex justify-between items-center mb-2'>
                <p className='text-blue-950 font-semibold text-2xl'>Feedback</p>
                <span><Trash2 color='#172554'/></span>
              </div>
              <div>
